...
/* This class was created but not used as this does not matches the given UI*/

class RatingView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null,
